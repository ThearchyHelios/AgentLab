...
def _source(n_tables: int, *, name: str = "bi", schema: str | None = "OWODS"):
    tables = {
        f"t{i}": {
...
def test_qualified_names_appear_in_summary():
    ...
    assert "OWODS.t0" in summary(_source(2))
